...
export declare function createVElement(tagName: string, attrs: SSkvObject | null, events: eventRecord | null, children: childrenArray | null, instance: Element | null): vElement;
